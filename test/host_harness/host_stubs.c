...
SCRATCH_PTR(sha512_h_scratch)
SCRATCH_PTR(sha512_k_scratch)
SCRATCH_PTR(sha512_w_scratch)
SCRATCH_PTR(sha512_padded_scratch)
SCRATCH_PTR(aead_state)
SCRATCH_PTR(aead_working)
SCRATCH_PTR(aead_keystream)
SCRATCH_PTR(aead_block_scratch)
SCRATCH_PTR(aead_otk)
SCRATCH_PTR(aead_mac_data)
SCRATCH_PTR(aead_computed_tag)
SCRATCH_PTR(hkdf_hmac_key_block)
SCRATCH_PTR(hkdf_hmac_msg_scratch)
SCRATCH_PTR(hkdf_hmac_inner_hash)
SCRATCH_PTR(hkdf_t_scratch)
SCRATCH_PTR(hkdf_hmac_input_scratch)
SCRATCH_PTR(keccak_state)
SCRATCH_PTR(keccak_temp)
SCRATCH_PTR(keccak_c)
SCRATCH_PTR(keccak_d)
SCRATCH_PTR(keccak_rc)
SCRATCH_PTR(keccak_rho)
SCRATCH_PTR(keccak_pi_dest)
SCRATCH_PTR(keccak_pad_scratch)
SCRATCH_PTR(mlkem_zetas)
SCRATCH_PTR(mlkem_gammas)
SCRATCH_PTR(mlkem_a00)
SCRATCH_PTR(mlkem_a01)
SCRATCH_PTR(mlkem_a10)
SCRATCH_PTR(mlkem_a11)
SCRATCH_PTR(mlkem_s0)
SCRATCH_PTR(mlkem_s1)
SCRATCH_PTR(mlkem_e0)
SCRATCH_PTR(mlkem_e1)
SCRATCH_PTR(mlkem_t0)
SCRATCH_PTR(mlkem_t1)
SCRATCH_PTR(mlkem_r0)
SCRATCH_PTR(mlkem_r1)
SCRATCH_PTR(mlkem_enc_e1_0)
SCRATCH_PTR(mlkem_enc_e1_1)
SCRATCH_PTR(mlkem_u0)
SCRATCH_PTR(mlkem_u1)
SCRATCH_PTR(mlkem_v)
SCRATCH_PTR(mlkem_mu)
SCRATCH_PTR(mlkem_w)
SCRATCH_PTR(mlkem_e2)
SCRATCH_PTR(mlkem_acc)
SCRATCH_PTR(mlkem_tmp1)
SCRATCH_PTR(mlkem_tmp2)
SCRATCH_PTR(mlkem_rho)
SCRATCH_PTR(mlkem_sigma)
SCRATCH_PTR(mlkem_prf_out)
SCRATCH_PTR(mlkem_xof_out)
SCRATCH_PTR(mlkem_h_buf)
SCRATCH_PTR(mlkem_z_buf)
SCRATCH_PTR(mlkem_mprime_buf)
SCRATCH_PTR(mlkem_kprime_buf)
SCRATCH_PTR(mlkem_rprime_buf)
SCRATCH_PTR(mlkem_kbar_buf)
SCRATCH_PTR(mlkem_ekpke_buf)
SCRATCH_PTR(mlkem_cprime_buf)
SCRATCH_PTR(tls_client_random)
SCRATCH_PTR(tls_server_random)
SCRATCH_PTR(tls_client_x25519_priv)
SCRATCH_PTR(tls_client_x25519_pub)
SCRATCH_PTR(tls_server_x25519_priv)
SCRATCH_PTR(tls_server_x25519_pub)
SCRATCH_PTR(tls_shared_secret)
SCRATCH_PTR(tls_server_id_priv)
SCRATCH_PTR(tls_server_id_pub)
SCRATCH_PTR(tls_early_secret)
SCRATCH_PTR(tls_derived_es)
SCRATCH_PTR(tls_handshake_secret)
SCRATCH_PTR(tls_c_hs_traffic)
SCRATCH_PTR(tls_s_hs_traffic)
SCRATCH_PTR(tls_c_hs_key)
SCRATCH_PTR(tls_c_hs_iv)
SCRATCH_PTR(tls_s_hs_key)
SCRATCH_PTR(tls_s_hs_iv)
SCRATCH_PTR(tls_derived_hs)
SCRATCH_PTR(tls_master_secret)
SCRATCH_PTR(tls_c_ap_traffic)
SCRATCH_PTR(tls_s_ap_traffic)
SCRATCH_PTR(tls_c_ap_key)
SCRATCH_PTR(tls_c_ap_iv)
SCRATCH_PTR(tls_s_ap_key)
SCRATCH_PTR(tls_s_ap_iv)
SCRATCH_PTR(tls_transcript)
SCRATCH_PTR(tls_ch)
SCRATCH_PTR(tls_sh)
SCRATCH_PTR(tls_ee)
SCRATCH_PTR(tls_cert)
SCRATCH_PTR(tls_cv)
SCRATCH_PTR(tls_s_fin)
SCRATCH_PTR(tls_c_fin)
SCRATCH_PTR(tls_hash_scratch)
SCRATCH_PTR(tls_hkdf_label_scratch)
SCRATCH_PTR(tls_cv_signed_content)
SCRATCH_PTR(tls_finished_key_scratch)
SCRATCH_PTR(tls_record_scratch)
SCRATCH_PTR(tls_record_aad)
SCRATCH_PTR(tls_record_nonce)
SCRATCH_PTR(tls_content_scratch)
SCRATCH_PTR(tls_tag_in)
SCRATCH_PTR(tls_rec_buf)
SCRATCH_PTR(tls_client_msg)
SCRATCH_PTR(tls_server_reply)
SCRATCH_PTR(tls_decrypted_scratch)
SCRATCH_PTR(tls_client_rx_buf)
SCRATCH_PTR(tls_client_rx_len)
SCRATCH_PTR(tls_server_rx_buf)
SCRATCH_PTR(tls_server_rx_len)
SCRATCH_PTR(tls_frame_scratch)
SCRATCH_PTR(tls_chunk_scratch)
SCRATCH_PTR(tls_recv_chunk_scratch)
SCRATCH_PTR(tls_ack_scratch)
SCRATCH_PTR(tls_ch_record)
SCRATCH_PTR(tls_sh_record)
SCRATCH_PTR(tls_parsed_client_random)
SCRATCH_PTR(tls_parsed_client_pub)
SCRATCH_PTR(tls_parsed_server_random)
...
SCRATCH_PTR(ed25519_l)
SCRATCH_PTR(ed25519_gx)
SCRATCH_PTR(ed25519_gy)
SCRATCH_PTR(ed25519_gz)
SCRATCH_PTR(ed25519_gt)
SCRATCH_PTR(ed25519_tmp1)
SCRATCH_PTR(ed25519_tmp2)
SCRATCH_PTR(ed25519_tmp3)
SCRATCH_PTR(ed25519_tmp4)
SCRATCH_PTR(ed25519_tmp5)
SCRATCH_PTR(ed25519_tmp6)
SCRATCH_PTR(ed25519_tmp7)
SCRATCH_PTR(ed25519_tmp8)
SCRATCH_PTR(ed25519_qx)
SCRATCH_PTR(ed25519_qy)
SCRATCH_PTR(ed25519_qz)
SCRATCH_PTR(ed25519_qt)
SCRATCH_PTR(ed25519_bx)
SCRATCH_PTR(ed25519_by)
SCRATCH_PTR(ed25519_bz)
SCRATCH_PTR(ed25519_bt)
SCRATCH_PTR(ed25519_scalar_remainder)
SCRATCH_PTR(ed25519_scalar_product)
SCRATCH_PTR(ed25519_scalar_sum)
SCRATCH_PTR(ed25519_hash_input)
SCRATCH_PTR(ed25519_hash_out)
SCRATCH_PTR(ed25519_buf1)
SCRATCH_PTR(ed25519_buf2)
SCRATCH_PTR(ed25519_buf3)
SCRATCH_PTR(ed25519_buf4)
SCRATCH_PTR(ed25519_buf5)
SCRATCH_PTR(ed25519_buf6)
SCRATCH_PTR(ed25519_buf7)
SCRATCH_PTR(ed25519_buf8)
SCRATCH_PTR(ed25519_ax)
SCRATCH_PTR(ed25519_ay)
SCRATCH_PTR(ed25519_az)
SCRATCH_PTR(ed25519_at)
SCRATCH_PTR(ed25519_rx)
SCRATCH_PTR(ed25519_ry)
SCRATCH_PTR(ed25519_rz)
SCRATCH_PTR(ed25519_rt)
SCRATCH_PTR(ed25519_kax)
SCRATCH_PTR(ed25519_kay)
SCRATCH_PTR(ed25519_kaz)
SCRATCH_PTR(ed25519_kat)
SCRATCH_PTR(ed25519_sbx)
SCRATCH_PTR(ed25519_sby)
SCRATCH_PTR(ed25519_sbz)
SCRATCH_PTR(ed25519_sbt)
SCRATCH_PTR(fsqueue_path_scratch)
SCRATCH_PTR(fsqueue_data_scratch)
SCRATCH_PTR(poly1305_block_scratch)
SCRATCH_PTR(pki_pinned_key)
SCRATCH_PTR(pki_sig_path_scratch)
SCRATCH_PTR(pki_sig_data_scratch)
SCRATCH_PTR(x25519_x1)
SCRATCH_PTR(x25519_x2)
SCRATCH_PTR(x25519_z2)
SCRATCH_PTR(x25519_x3)
SCRATCH_PTR(x25519_z3)
SCRATCH_PTR(x25519_a)
SCRATCH_PTR(x25519_aa)
SCRATCH_PTR(x25519_b)
SCRATCH_PTR(x25519_bb)
SCRATCH_PTR(x25519_e)
SCRATCH_PTR(x25519_c)
SCRATCH_PTR(x25519_d)
SCRATCH_PTR(x25519_da)
SCRATCH_PTR(x25519_cb)
SCRATCH_PTR(x25519_a24e)
SCRATCH_PTR(x25519_product_scratch)
SCRATCH_PTR(x25519_invert_base)
SCRATCH_PTR(x25519_invert_result)
SCRATCH_PTR(x25519_p_bytes)
SCRATCH_PTR(x25519_p_minus_2_bytes)
SCRATCH_PTR(x25519_p9_bytes)
SCRATCH_PTR(x25519_fold_t)
SCRATCH_PTR(x25519_fold_s)
SCRATCH_PTR(x25519_a24_bytes)
